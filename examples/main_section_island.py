...
if __name__ == "__main__":
    ...
    print(isl2._give_animals_in_cell(2, 2))
    ...
    herb, carn = isl2._give_animals_in_cell(2, 2)
    print(f"\nAnimals in (2, 2):", len(herb + carn))
    herb, carn = isl2._give_animals_in_cell(2, 3)
    print(f"Animals in (2, 3):", len(herb + carn))
    herb, carn = isl2._give_animals_in_cell(2, 4)
    print(f"Animals in (2, 4):", len(herb + carn))
    herb, carn = isl2._give_animals_in_cell(3, 2)
    print(f"\nAnimals in (3, 2):", len(herb + carn))
    herb, carn = isl2._give_animals_in_cell(3, 3)
    print(f"Animals in (3, 3):", len(herb + carn))
    herb, carn = isl2._give_animals_in_cell(3, 4)
    print(f"Animals in (3, 4):", len(herb + carn))
    herb, carn = isl2._give_animals_in_cell(4, 2)
    print(f"\nAnimals in (4, 2):", len(herb + carn))
    herb, carn = isl2._give_animals_in_cell(4, 3)
    print(f"Animals in (4, 3):", len(herb + carn))
    herb, carn = isl2._give_animals_in_cell(4, 4)
